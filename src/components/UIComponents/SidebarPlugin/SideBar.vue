    ...
    <div class="sidebar-wrapper">
      ...
      <ul class="nav nav-mobile-menu">
        <li><a href="#/" class="dropdown-toggle active" data-toggle="dropdown">
          ...
          <p class="hidden-lg hidden-md">Dashboard</p></a></li>
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="material-icons">notifications</i><span
        ...
        <li><a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="material-icons">person</i>
          <p class="hidden-lg hidden-md">Profile</p></a></li>
      </ul>
      <ul :class="navClasses">
